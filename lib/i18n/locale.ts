...
export const META: Record<Locale, { title: string; description: string; ogLocale: string }> = {
  ko: {
    title: "OpenArm 2.0 | 오픈소스 양팔 로봇 · 피지컬 AI 데브킷 | 리버트론",
    description:
      "OpenArm 2.0 — 100% 오픈소스 양팔 로봇암. 피지컬 AI, 누구나 손쉽게. 리버트론이 한국에서 조립·검수하고, 국내는 배송·설치·시연까지 원스톱으로 지원합니다.",
    ogLocale: "ko_KR",
  },
  en: {
    title: "OpenArm 2.0 | Open-Source Bimanual Robot · Physical-AI Devkit | Libertron",
    description:
      "OpenArm 2.0 — a 100% open-source bimanual robot arm for physical-AI research, education, and development. Assembled and tested in Korea by Libertron, shipped worldwide.",
    ogLocale: "en_US",
  },
};
