...
export default function ResourcesPage() {
  ...
  const faq: [string, string][] = lang === "en" ? [
    ...
    ["How do you teach the robot?", "Several methods are supported. You can use a traditional teach pendant, leader–follower teleoperation with KER, kinesthetic teaching by moving the arm by hand, and direct control through the ROS 2, Python, and CAN-FD APIs. From a first encounter with physical AI to full development, every option stays open."],
    ...
    ["로봇을 어떻게 가르치나요?", "여러 방식을 지원합니다. 전통적인 티칭 펜던트는 물론, KER을 이용한 리더-팔로워 텔레오퍼레이션, 로봇 팔을 손으로 직접 잡는 kinesthetic 티칭, ROS 2·Python·CAN-FD API를 통한 직접 제어까지 가능합니다. 피지컬 AI를 처음 접하는 단계부터 본격적인 개발까지, 원하는 방식을 열어 둡니다."],
