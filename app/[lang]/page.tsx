...
const KO = {
  ...
  faq: [
    ...
    { q: "대학 연구실이나 고등학교 로봇 수업용으로 적합한가요?", a: "잘 맞습니다. 크기가 작고 가벼워 좁은 실습 공간에서도 안전하게 다룰 수 있습니다. 로봇을 직접 손으로 잡고 움직여 동작을 가르치거나(kinesthetic teaching) 리더암으로 시연해 그대로 따라 하게 하는 직관적인 방식이라 처음 접하는 학생도 금세 익히고, ROS 2·Python API로 심화 실습까지 이어갈 수 있습니다. 기초 코딩 실습부터 심화 로봇 역학 연구까지 두루 활용할 수 있습니다." },
