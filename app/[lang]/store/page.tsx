...
const KO: Record<string, string> = {
  ...
  estnote: "※ 가격은 조합과 구성에 따라 달라지기 때문에, 원하시는 조합으로 문의 주시면 빠르게 확인하여 회신드리겠습니다. 국내 배송(DTD)·초기 설치 및 시연 지원·세금계산서/견적서 발행·사용 중 문제 피드백 지원 등의 비용이 포함되어 있습니다. 간편한 피지컬 AI 도입을 지원하기 위해 최선을 다하겠습니다.",
  vat: "부가세 별도",
