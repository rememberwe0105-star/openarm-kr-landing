...
.oas .pbadge{position:absolute;top:16px;left:18px;background:var(--cy);color:#fff;font-family:var(--mono);font-size:11px;font-weight:700;padding:5px 11px;border-radius:6px;z-index:2;letter-spacing:.04em}
