...
const KO = {
  ...
  k_feat: "Core — 2.0의 핵심", h_feat: "OpenArm 2.0을 <em>구매해야 하는 이유</em>",
  ...
  act_k: "In Action — 실제 구동", act_h: "<em>실제 구동 영상</em>으로 확인하세요", act_cap: "// OPENARM 2.0 · 실제 구동 영상",
  k_hw: "Hardware — 손끝으로 살펴보기", h_hw: "<em>2.0 하드웨어</em>를 직접 돌려보세요",
  ...
  k_apps: "Applications — 활용 분야", apps_h: "이런 연구에 <em>활용할 수 있습니다</em>",
  ...
  k_eco: "Ecosystem — 함께 확장되는 셋업", h_eco: "2.0을 더 유용하게, <em>강력한 추가 옵션</em>",
  ...
  faq: [
    ...
    { q: "그리퍼나 카메라 같은 액세서리를 추가할 수 있나요?", a: "네. 기본 제공되는 리더·팔로워 그리퍼 외에도 주문형 그리퍼와 흡착 펌프 등 다양한 엔드이펙터(End Effector)를 준비하고 있습니다. 상단에는 깊이 정보까지 담는 Depth 카메라(Intel RealSense D435IF, D455F, D405 등)를 옵션으로 장착할 수 있어, 비전 AI 기반의 자율 픽앤플레이스도 어렵지 않게 구현됩니다." },
  ...
  k_contact: "Contact — 도입 문의", ct_h: "궁금한 점을 <em>문의해 주세요</em>",
