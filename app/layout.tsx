          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify([
              ...
              },
              {
                ...
                "image": [
                  "https://openarm.co.kr/og-parts.png"
                ],
                "brand": {
                  "@type": "Brand",
                  "name": "Libertron"
              ...
              },
              {
                ...
                "mainEntity": [
                  ...
                  },
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "네. 기본 제공되는 리더·팔로워 그리퍼 외에도 주문형 그리퍼와 흡착 펌프 등 다양한 엔드이펙터(End Effector)를 테스트 해볼 수 있습니다. 오픈소스 하드웨어를 제공하기 때문에 CNC, 3D 프린터 등을 활용하여 어댑터를 제작하고 결합해보는 과정도 어렵지 않게 가능합니다. 상단에는 깊이 정보까지 담는 Depth 카메라(ZED Mini 스테레오 카메라)를 옵션으로 장착할 수 있어, 비전 AI 기반의 자율 픽앤플레이스도 테스트 해볼 수 있습니다."
                    }
                  },
                  {
                    "@type": "Question",
