    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-sm font-medium">
          <Link href="/#specs" className="hover:text-point transition-colors">Specs</Link>
          <Link href="/#features" className="hover:text-point transition-colors">Features</Link>
          <Link href="/#get-started" className="hover:text-point transition-colors">Resources</Link>
          <Link href="/#why-korea" className="hover:text-point transition-colors">Libertron</Link>
        </div>
        <Link 
          href="/products" 
